...
public class BusinessUnitSerivceImpl implements BusinessUnitService {
    ...
    public static final String  BUSINESS_UNIT_URL = "http://localhost:8081/business-units";
    ...
    public List<BusinessUnitDTO> findAll() {
        ...
        ResponseEntity<BusinessUnitDTO[]> entity = restTemplate.getForEntity(BUSINESS_UNIT_URL, BusinessUnitDTO[].class);
